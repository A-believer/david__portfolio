  ...
  return (
    <main className=' flex justify-between items-center px-[100px] py-[20px] my-[100px]'>
      <div className='text-white font-lobster text-[75px] leading-[90px] font-n'>
        ...
        <button className='text-[18px] leading-[22px] font-inter font-vb bg-secondary px-[50px] py-[20px] rounded-[5px]'><Link to='/projects' className='bg-secondary'>My Projects</Link></button>
      </div>
      <div>
